export const socialLinks = {
  linkedin: "https://www.linkedin.com/in/pushpika-lakra-022079374",
  github: "https://github.com/pushpikalakra1509-rgb",
  email: "mailto:pushpikalakra1509@gmail.com",
};

export const project = {
  number: "01",
  year: "2026",
  status: "LIVE / DATA SCIENCE",
  title: "CityPulse",
  subtitle: "Urban Mobility Intelligence",
  description:
    "An end-to-end urban traffic analytics project using Python, SQL, statistical analysis and interactive visualization to investigate congestion patterns, rush hours, anomalies and junction-level traffic behaviour.",
  tags: ["Python", "Pandas", "SQL", "Statistics", "Plotly", "Streamlit"],
  live: "https://citypulse-pjtncw4yhu3lnmq9syiec8.streamlit.app/",
  github: "https://github.com/pushpikalakra1509-rgb/CityPulse",
};
...
export const softSkills = [
  { title: "Team Management", note: "Coordinating people, responsibilities and moving parts." },
  { title: "Communication", note: "Keeping ideas clear and people on the same page." },
  { title: "Leadership", note: "Organising and taking responsibility when a team needs direction." },
  { title: "Collaboration", note: "Building with people rather than working in a bubble." },
  { title: "Organisation", note: "Planning work, events and responsibilities without losing the thread." },
  { title: "Problem Solving", note: "Breaking unfamiliar problems into smaller things I can actually test." },
